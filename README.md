...
| [`.FilterFilter`](https://hexdocs.pm/credo/Credo.Check.Refactor.FilterFilter.html)                           | Combines consecutive filter calls       | [Pipe Chains](docs/pipes.md#piped-function-optimizations)             |              |
